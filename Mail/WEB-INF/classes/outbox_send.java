...
public class outbox_send extends HttpServlet implements SingleThreadModel
{
	String url;
	Connection con;
	Statement stmt;
	...
	public void doPost(HttpServletRequest request,HttpServletResponse response) throws IOException, ServletException
   	{
		try
		{
			...
			while(rs.next())
			{
				if(to.equals(rs.getString("Username")))
				{flag=true;}
			}
			...
			out.println("</table>");
			if(flag==true)
			out.println("<h1 align='center'><font size='5'>Mail sent</font></h1>");
			else
