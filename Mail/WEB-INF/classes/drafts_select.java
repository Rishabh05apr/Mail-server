...
public class drafts_select extends HttpServlet implements SingleThreadModel
{
	String url;
	Connection con;
	Statement stmt;
	...
	public void doPost(HttpServletRequest request,HttpServletResponse response) throws IOException, ServletException
   	{
		try
		{
			...
			out.println("<tr>");
				out.println("<td>");
				out.println("<form method='post' action='drafts1'>");
			...
			out.println("</form>");
			out.println("</table>");
			out.println("<h1 align='center'><font size='5'>Please select a mail</font></h1>");
			out.println("</body>");
			out.println("</html>");
