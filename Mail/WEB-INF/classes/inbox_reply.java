...
public class inbox_reply extends HttpServlet implements SingleThreadModel
{
	String url;
	Connection con;
	Statement stmt;
	...
	{	try{
		...
		out.println("<table align='center' border='2' cellpadding='3' bordercolor='blue'>");
			out.println("<tr>");
				...
				out.println("</th>");
				out.println("<th>");
				out.println("<input type='text' name='to' value="+rs.getString("From")+"></input>");
				out.println("</th>");
			out.println("</tr>");
			out.println("<tr>");
				out.println("<th>");
				...
				out.println("</th>");
				out.println("<th>");
				out.println("<input type='text' name='subject' value=''></input>");
				out.println("</th>");
			out.println("</tr>");
			out.println("<tr>");
