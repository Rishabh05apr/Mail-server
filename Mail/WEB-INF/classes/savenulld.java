...
public class savenulld extends HttpServlet implements SingleThreadModel
{
	String check;
	...
	{	try{
		...
		out.println("<br/>");
		out.println("<br/>");
		out.println("<form method='post' action='drafts_send'>");
		out.println("<table align='center' border='2' cellpadding='3' bordercolor='blue'>");
			out.println("<tr>");
				...
				out.println("</th>");
				out.println("<th>");
				out.println("<input type='text' name='to'></input>");
				out.println("</th>");
			out.println("</tr>");
			out.println("<tr>");
				out.println("<th>");
				...
				out.println("</th>");
				out.println("<th>");
				out.println("<input type='text' name='subject'></input>");
				out.println("</th>");
			out.println("</tr>");
			out.println("<tr>");
				out.println("<th colspan=2>");
				out.println("<textarea name='message' rows='10'></textarea>");
				out.println("</th>");
			out.println("</tr>");
		...
		out.println("</form>");
		out.println("</table>");
		out.println("<h1 align='center'>Cannot save an empty mail<h1>");
		out.println("</body>");
		out.println("</html>");
	}
	catch(Exception e)
