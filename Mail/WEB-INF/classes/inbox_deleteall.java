...
public class inbox_deleteall extends HttpServlet implements SingleThreadModel
{
	String url;
	Connection con;
	...
	PrintWriter out;
	String check,user;
	String from,subject,message,date,username;
	...
	public void doPost(HttpServletRequest request,HttpServletResponse response) throws IOException, ServletException
   	{
		try
		{
			...
			out.println("</form>");
			out.println("</table>");
			out.println("<h1 align='center'><font size='5'>All mails deleted</h1>");
			out.println("</body>");
			out.println("</html>");
