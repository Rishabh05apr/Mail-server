...
public class inbox extends HttpServlet implements SingleThreadModel
{
	String url;
	Connection con;
	Statement stmt;
	...
	public void doPost(HttpServletRequest request,HttpServletResponse response) throws IOException, ServletException
   	{
		try
		{
			...
			out.println("<table bgcolor='black' align='center' border='1' bordercolor='green'>");
			out.println("<tr>");
				out.println("<th>");
			...
			out.println("</table>");
			out.println("</br></br>");
			out.println("<table bgcolor='black' align='left' border='2' bordercolor='blue'>");
			out.println("<tr>");
				out.println("<td>");
				out.println("<form method='post' action='inbox1'>");
